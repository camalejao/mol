...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
	...
	<div class="content-wrapper">
		<div class="container-fluid">
			...
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a href="cadastrarUsuario">Cadastro
						de Período</a></li>
				<li class="breadcrumb-item active">Cadastro de Período</li>
			</ol>
			<div class="row">
				<div class="col-12">
					<div class="card card-register mx-auto mt-2 mb-2">
						<div class="card-header">Cadastro de Período</div>
						<div class="card-body">
							<form:form modelAttribute="periodo" action="inserePeriodo" method="POST">
								<div class="form-row">
									<div class="form-group col-md-6">
										<label for="selectAno">Ano</label>
										<form:select id="selectAno" class="form-control" path="ano" required="true">
											<c:forEach var="ano" begin="2018" end="2028">
												<form:option value="${ano}">${ano}</form:option>
											</c:forEach>
										</form:select>
									</div>
									<div class="form-group col-md-6">
										<label for="selectEntrada">Semestre de Entrada</label>
										<form:select id="selectModalidade" class="form-control" path="entrada">
											<c:forEach items="${entrada}" var="e">
												<form:option value="${e}">Semestre ${e.semestre}</form:option>
											</c:forEach>
										</form:select>
									</div>
								</div>
								<div class="form-row">
									<div class="form-group col-md-6">
										...
										<div class="input-group date" id="datetimepickerInicio" data-target-input="nearest">
											<form:input type="text" path="dataInicio" class="form-control datetimepicker-input"
												data-target="#datetimepickerInicio" id="dateInicio" required="true" />
									...
									<div class="form-group col-md-6">
										<label for="dateFim">Data de fim</label>
										<div class="input-group date" id="datetimepickerFim" data-target-input="nearest">
											<form:input type="text" path="dataFim" class="form-control datetimepicker-input"
												data-target="#datetimepickerFim" id="dateFim" required="true" />
											<div class="input-group-append" data-target="#datetimepickerFim" data-toggle="datetimepicker">
												<div class="input-group-text"><i class="fa fa-calendar"></i></div>
											</div>
										</div>
									</div>
		...
		<script src="webjars/tempusdominus-bootstrap-4/5.0.0/js/tempusdominus-bootstrap-4.min.js"></script>
