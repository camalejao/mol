...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
	...
	<div class="content-wrapper">
		<div class="container-fluid">
									...
									<div class="form-row">
										...
										<div class="col-md-6">
											...
											<form:input path="matricula" class="form-control"
												...
												onchange="verificaMatProf(this.value)" />
			...
			<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog"
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<div class="modal-body">Selecione "sair" se deseja encerrar
							a sessão atual.</div>
			...
			<script
				src="webjars/startbootstrap-sb-admin/4.0.0/js/sb-admin.min.js"></script>
			<!-- Validação com Ajax -->
