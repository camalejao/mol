			...
			<div class="row">
				<div class="col-12">
					<div class="card card-register mx-auto mt-2 mb-2">
						<div class="card-header">Cadastro de Curso</div>
						<div class="card-body">
							<form:form modelAttribute="curso" action="insereCurso" method="POST">
								<div class="form-group">
									<label for="inputNome">Nome</label>
									<form:input path="nome" class="form-control" id="inputNome"
										type="text" placeholder="Nome do curso" required="true" maxlegth="30" />
									<form:errors path="nome" cssClass="text-danger" />
								</div>
								<div class="form-row">
									<div class="form-group col-md-6">
										<label for="inputCH">Carga Horária</label>
										<form:input path="cargaHoraria" class="form-control" id="inputCH"
											type="number" value="600" min="200" max="6000" />
										<form:errors path="cargaHoraria" cssClass="text-danger" />
									</div>
									<div class="form-group col-md-6">
										<label for="selectModalidade">Modalidade</label>
										<form:select id="selectModalidade" class="form-control" path="modalidade">
											<c:forEach items="${modalidades}" var="m">
												<form:option value="${m}">${m.descricao}</form:option>												</c:forEach>
										</form:select>
									</div>
								</div>
