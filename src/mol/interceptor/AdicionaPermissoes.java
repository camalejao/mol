...
public class AdicionaPermissoes {
	...
	public static void main(String[] args) {
		...
		lp.add(new Permissoes("homeAluno", TipoUsuario.MONITOR));
		lp.add(new Permissoes("homeMonitor", TipoUsuario.MONITOR));
		lp.add(new Permissoes("responderAtividade-{id}", TipoUsuario.ALUNO));
		lp.add(new Permissoes("responderAtividade-{id}", TipoUsuario.MONITOR));
		lp.add(new Permissoes("enviarResposta", TipoUsuario.ALUNO));
		lp.add(new Permissoes("enviarResposta", TipoUsuario.MONITOR));
		lp.add(new Permissoes("downloadResposta-{id}", TipoUsuario.ALUNO));
		lp.add(new Permissoes("downloadResposta-{id}", TipoUsuario.MONITOR));
		lp.add(new Permissoes("downloadAtividade-{id}", TipoUsuario.ALUNO));
		lp.add(new Permissoes("downloadAtividade-{id}", TipoUsuario.MONITOR));
		...
		lp.add(new Permissoes("disciplinas", TipoUsuario.MONITOR));
		lp.add(new Permissoes("verCorrecoes-{id}", TipoUsuario.ALUNO));
		lp.add(new Permissoes("verCorrecoes-{id}", TipoUsuario.MONITOR));
		lp.add(new Permissoes("sumario-{id}", TipoUsuario.ALUNO));
		lp.add(new Permissoes("sumario-{id}", TipoUsuario.MONITOR));
		...
		lp.add(new Permissoes("downloadMd", TipoUsuario.MONITOR));
		...
		lp.add(new Permissoes("requisitaItem", TipoUsuario.MONITOR));
		lp.add(new Permissoes("requisitaItemResposta", TipoUsuario.ALUNO));
		lp.add(new Permissoes("requisitaItemResposta", TipoUsuario.MONITOR));
		lp.add(new Permissoes("salvarRespostaItem", TipoUsuario.ALUNO));
		lp.add(new Permissoes("salvarRespostaItem", TipoUsuario.MONITOR));
		...
		lp.add(new Permissoes("adicionarDuvida", TipoUsuario.ALUNO));
		lp.add(new Permissoes("adicionarDuvida", TipoUsuario.MONITOR));
		lp.add(new Permissoes("minhasDuvidas", TipoUsuario.ALUNO));
		lp.add(new Permissoes("minhasDuvidas", TipoUsuario.MONITOR));
		lp.add(new Permissoes("verDuvidas-{id}", TipoUsuario.ALUNO));
		lp.add(new Permissoes("verDuvidas-{id}", TipoUsuario.MONITOR));
		lp.add(new Permissoes("verDuvidas", TipoUsuario.PROFESSOR));
		...
		lp.add(new Permissoes("editarUsuario", TipoUsuario.ADMINISTRADOR));
		lp.add(new Permissoes("excluirDisciplina", TipoUsuario.ADMINISTRADOR));
		lp.add(new Permissoes("editaDisciplina", TipoUsuario.ADMINISTRADOR));
		lp.add(new Permissoes("removerMonitor", TipoUsuario.ADMINISTRADOR));
		lp.add(new Permissoes("responderDuvida", TipoUsuario.PROFESSOR));
		lp.add(new Permissoes("duvidasAtividade-{id}", TipoUsuario.PROFESSOR));
